...
En 1997 , el IMG(Intelligent Mechanisms Group ) de la NASA y el instituto de robótica de la  CMU( Carnegie Mellon University) desarrollaron las \textbf{interfaces de control} necesarias para teledirigir a Nomad, un robot diseñado para la exploración de planetas.\cite{Nguyen2001}
